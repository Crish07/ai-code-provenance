...
// Status mirrors docs/MCP Tool API Specification.md §5 verify.status.
type Status string
...
// Verify reads the diff for req.Scope, matches each added non-blank line
// against unremoved AI provenance rows by file_path + content_hash, and
